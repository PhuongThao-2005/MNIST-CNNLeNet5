...
def get_all_datasets(batch_size: int = BATCH_SIZE):
    ...
    return {
        "handwritten": {
            "train": handwritten_train,        # dataloader train
            "test": handwritten_test,          # dataloader test
            "classes": handwritten_classes,    # tên class
            "num_classes": len(handwritten_classes),  # số class
        },
        "fashion": {
            "train": fashion_train,
            "test": fashion_test,
